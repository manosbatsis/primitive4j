...
public class DomainPrimitiveConversionException extends IllegalArgumentException {

    static DomainPrimitiveConversionException errorConvertingToDatabaseColumn(Exception e) {
