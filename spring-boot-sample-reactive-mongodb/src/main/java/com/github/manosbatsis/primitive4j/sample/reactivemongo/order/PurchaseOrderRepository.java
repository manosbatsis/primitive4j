...
public interface PurchaseOrderRepository extends ReactiveMongoRepository<PurchaseOrder, UUID> {
    Flux<PurchaseOrder> findAllByCustomerRef(CustomerRef customerRef);
}
